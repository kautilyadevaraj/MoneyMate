...
export class BamlAsyncClient {
  ...
  async ExtractTransactions(
    ...
    try {
      ...
      return raw.parsed(false) as types.Transaction[]
    } catch (error) {
...
class BamlStreamClient {
  ...
  ExtractTransactions(
      transaction: string,
      __baml_options__?: BamlCallOptions
  ): BamlStream<partial_types.Transaction[], types.Transaction[]> {
    try {
      const options = { ...this.bamlOptions, ...(__baml_options__ || {}) }
      const signal = options.signal;
      ...
      return new BamlStream<partial_types.Transaction[], types.Transaction[]>(
        raw,
        (a): partial_types.Transaction[] => a,
        (a): types.Transaction[] => a,
        this.ctxManager.cloneContext(),
        options.signal,
      )
    } catch (error) {
