...
export default class TypeBuilder {
    ...
    Transaction: ClassViewer<'Transaction', "date" | "transaction_id" | "name" | "type" | "amount">;
    ...
    constructor() {
        ...
        this.Transaction = this.tb.classViewer("Transaction", [
          "date","transaction_id","name","type","amount",
        ]);
